          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-8 shadow-xl border border-white/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                ...
                <div className="space-y-2">
                  <p className="text-white/80">Автомобилей: <span className="text-blue-400">0</span></p>
                  <p className="text-white/80">Сообщений: <span className="text-green-400">0</span></p>
                  <p className="text-white/80">Просмотров: <span className="text-yellow-400">0</span></p>
                </div>
              </div>
            </div>
            
            <div className="mt-8 p-6 bg-white/5 rounded-lg border border-white/10">
              <h3 className="text-xl font-semibold text-white mb-4">Добро пожаловать в BEZNOMERA!</h3>
              <p className="text-white/80">
                Это защищенная страница, доступная только авторизованным пользователям. 
                Система аутентификации успешно работает!
              </p>
            </div>
          </div>
        </div>
